...
# Read in shapefile
```{r}
E_EPoly2_1 = readOGR("../data/Part2-Vectors-HarmEA/E_EPoly2_1_ee_HarmEaFires_2019.shp", "E_EPoly2_1_ee_HarmEaFires_2019") 
NEPoly1 = readOGR("../data/Part2-Vectors-HarmEA/NEPoly1_ee_HarmEaFires_2019.shp", "NEPoly1_ee_HarmEaFires_2019") 
W_EPoly2_2 = readOGR("../data/Part2-Vectors-HarmEA/W_EPoly2_2_ee_HarmEaFires_2019.shp", "W_EPoly2_2_ee_HarmEaFires_2019") 
...
# write Shapefile
```{r}
st_write(all_shp_cast, "../outputs/2.1-GEE-clean-shapefiles-EqualArea/combine1_equalarea_2019.shp", driver="ESRI Shapefile") 
```
