---
title: "Climate Fire June/july Analysis"
author: "Anna Talucci"
date: "6/20/2021"
...
plot_fit1 = ggplot(data = climate, aes(x = JuneDef, y = MHa)) + 
  ...
  scale_color_manual(values=cbbPalette) +
    ylab("") +
    xlab("June Climate Moisture Deficit (mm)") +
...
ggsave("../figures/Analysis/JuneDefAnalysis.png", plot = plot_fit1, width = 6, height = 7, units = c("in"), dpi=600 )
```
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/Analysis/JunePrAnalysis.png", plot = plot_fit2, width = 6, height = 7, units = c("in"), dpi=600 )
```
...
plot_fit3 = ggplot(data = climate, aes(x = JuneTmmx, y = MHa)) + 
  ...
  scale_color_manual(values=cbbPalette) +
  ylab("") +
  xlab(expression(atop(paste("June mean maximum temperature (", degree,"C)")))) +
  facet_wrap(~EcoCode, scales = "free", ncol=4 ) +
  theme_bw() +
  theme(strip.background = element_rect(color=NA, fill="white", size=1.5, linetype="solid")) 
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/Analysis/JuneTmmxAnalysis.png", plot = plot_fit3, width = 6, height = 7, units = c("in"), dpi=600 )
```
...
comboplot1 = cowplot::plot_grid(plot_fit1, plot_fit2, plot_fit3, ncol=1)

comboplot1
```

```{r eval=FALSE, include=FALSE}
ggsave("../figures/Analysis/JuneClimateTrends.png", plot = comboplot1, width = 6, height = 7, units = c("in"), dpi=600 )
```
**THE END**