...
## Fire perimeters
```{r}
fires = st_read("../data/GEE-clean-shapefiles-EqualArea/combine_ecozones_ea_2001.shp", "combine_ecozones_ea_2001") 
```
...
## Hotspots
```{r}
hotspots = st_read("../data/M6-march-october/M6_mar-oct_2005.shp", "M6_mar-oct_2005") 
```
...
```{r}
st_write(fires_at_eco_arc_hs_merge_burn, "../outputs/GEE-Attribute-Shapefiles-EqualArea/ru-fires-2001.shp", driver="ESRI Shapefile") 
