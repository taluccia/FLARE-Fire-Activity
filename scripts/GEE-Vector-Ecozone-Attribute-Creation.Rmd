...
%>%summarize(min_acq_date = min(ACQ_DATE))
...
fires_at_eco_arc_hs_merge %>%
  ...
  mutate(Fire_ID = paste("RU", fire_yr, eco_code, min_julian_date, sep = "-")) 
...
```{r eval=FALSE, include=FALSE}
st_write(fires_at_eco_arc_hs_merge, "../outputs/test/test_attributes-remove_dup.shp", driver="ESRI Shapefile") 
