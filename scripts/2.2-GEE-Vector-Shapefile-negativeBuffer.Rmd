...
# Read in shapefile
```{r}
vec = readOGR("../data/2.1-GEE-clean-shapefiles-EqualArea/combine1_equalarea_2019.shp", "combine1_equalarea_2019") 
```
...
```{r}
st_write(vec_simp, "../outputs/2.2-GEE-clean-shapefiles-EqualArea/nbuf_equalarea_2019.shp", driver="ESRI Shapefile") 
```