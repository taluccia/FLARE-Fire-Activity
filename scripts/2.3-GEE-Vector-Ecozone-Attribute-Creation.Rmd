...
## Fire perimeters
```{r}
fires = st_read("../data/2.2-GEE-clean-shapefiles-EqualArea/nbuf_equalarea_2004.shp", "nbuf_equalarea_2004") 
```
...
## Hotspots
```{r}
hotspots = st_read("../data/M6-march-october/M6_mar-oct_2004.shp", "M6_mar-oct_2004") 
```
...
# Write to shapefile
```{r}
st_write(fires_at_eco_arc_hs_merge_burn_rh, "../outputs/2.3-GEE-Attribute-Shapefiles-EqualArea/SiberiaFires_2004.shp", driver="ESRI Shapefile") 
```
