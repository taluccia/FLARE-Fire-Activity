...
```{r}
st_write(f01_ecozone, "../outputs/perimeter_summary/arctic/perimeters2001.shp", driver="ESRI Shapefile") 
st_write(f02_ecozone, "../outputs/perimeter_summary/arctic/perimeters2002.shp", driver="ESRI Shapefile") 
st_write(f03_ecozone, "../outputs/perimeter_summary/arctic/perimeters2003.shp", driver="ESRI Shapefile") 
st_write(f04_ecozone, "../outputs/perimeter_summary/arctic/perimeters2004.shp", driver="ESRI Shapefile") 
st_write(f05_ecozone, "../outputs/perimeter_summary/arctic/perimeters2005.shp", driver="ESRI Shapefile") 
st_write(f06_ecozone, "../outputs/perimeter_summary/arctic/perimeters2006.shp", driver="ESRI Shapefile") 
st_write(f07_ecozone, "../outputs/perimeter_summary/arctic/perimeters2007.shp", driver="ESRI Shapefile") 
st_write(f08_ecozone, "../outputs/perimeter_summary/arctic/perimeters2008.shp", driver="ESRI Shapefile") 
st_write(f09_ecozone, "../outputs/perimeter_summary/arctic/perimeters2009.shp", driver="ESRI Shapefile") 
st_write(f10_ecozone, "../outputs/perimeter_summary/arctic/perimeters2010.shp", driver="ESRI Shapefile") 
st_write(f11_ecozone, "../outputs/perimeter_summary/arctic/perimeters2011.shp", driver="ESRI Shapefile") 
st_write(f12_ecozone, "../outputs/perimeter_summary/arctic/perimeters2012.shp", driver="ESRI Shapefile") 
st_write(f13_ecozone, "../outputs/perimeter_summary/arctic/perimeters2013.shp", driver="ESRI Shapefile") 
st_write(f14_ecozone, "../outputs/perimeter_summary/arctic/perimeters2014.shp", driver="ESRI Shapefile") 
st_write(f15_arctic, "../outputs/perimeter_summary/arctic/perimeters2015.shp", driver="ESRI Shapefile") 
st_write(f16_arctic, "../outputs/perimeter_summary/arctic/perimeters2016.shp", driver="ESRI Shapefile") 
st_write(f17_arctic, "../outputs/perimeter_summary/arctic/perimeters2017.shp", driver="ESRI Shapefile") 
st_write(f18_arctic, "../outputs/perimeter_summary/arctic/perimeters2018.shp", driver="ESRI Shapefile") 
