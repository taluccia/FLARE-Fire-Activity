...
# Read in shapefile
```{r}
E_EPoly2_1 = readOGR("../data/2021-05-03_GEE-part2-vectors-EA/E_EPoly2_1_ee_fires_2002.shp", "E_EPoly2_1_ee_fires_2002") 
NEPoly1 = readOGR("../data/2021-05-03_GEE-part2-vectors-EA/NEPoly1_ee_fires_2002.shp", "NEPoly1_ee_fires_2002") 
W_EPoly2_2 = readOGR("../data/2021-05-03_GEE-part2-vectors-EA/W_EPoly2_2_ee_fires_2002.shp", "W_EPoly2_2_ee_fires_2002") 
...
# write Shapefile
```{r}
st_write(all_shp_smooth, "../outputs/GEE-clean-shapefiles-EqualArea/combine_equalarea_2002.shp", driver="ESRI Shapefile") 
```
