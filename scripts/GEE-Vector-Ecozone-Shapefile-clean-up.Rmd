...
Using GEE Part 2 Vectors Ecozone, we combine ecozone shapefiles, clean polygons, and add attributes
...
f19 = readOGR("../data/FLARE-Fires-30m/2019/2019_flare_fires.shp", "2019_flare_fires")
f20 = readOGR("../data/FLARE-Fires-30m/2020_flare_fires.shp", "2020_flare_fires")
...
st_write(f19_wgs, "../outputs/clean-shapefile/flare_30m/fires2019.shp", driver="ESRI Shapefile") 
