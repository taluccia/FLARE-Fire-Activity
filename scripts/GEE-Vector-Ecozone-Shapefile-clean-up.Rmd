...
# Read in shapefile
```{r}
E_EPoly2_1 = readOGR("../data/2Part2-Vectors-HarmEA/E_EPoly2_1_ee_HarmEaFires_2001.shp", "E_EPoly2_1_ee_HarmEaFires_2001") 
NEPoly1 = readOGR("../data/Part2-Vectors-HarmEA/NEPoly1_ee_HarmEaFires_2001.shp", "NEPoly1_ee_HarmEaFires_2001") 
W_EPoly2_2 = readOGR("../data/Part2-Vectors-HarmEA/W_EPoly2_2_ee_HarmEaFires_2001.shp", "W_EPoly2_2_ee_HarmEaFires_2001") 
...
```{r}
all_shp_smooth <- smooth(all_shp_cast, method = "ksmooth", smoothness = 2)
```
...
```{r}
all_shp_simp = ms_simplify(all_shp_smooth)
```


# write Shapefile
```{r}
st_write(all_shp_simp, "../outputs/GEE-clean-shapefiles-EqualArea/combine_equalarea_2001.shp", driver="ESRI Shapefile") 
```
