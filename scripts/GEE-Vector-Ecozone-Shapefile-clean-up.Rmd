...
```{r}
ckmt_nst_nsct = st_read("../data/GEE-test/ckmt_nst_nsct_fires_2001.shp", "ckmt_nst_nsct_fires_2001") 
cpt_bt_east = st_read("../data/GEE-test/cpt_bt_east_fires_2001.shp", "cpt_bt_east_fires_2001") 
cpt_bt_west = st_read("../data/GEE-test/cpt_bt_west_fires_2001.shp", "cpt_bt_west_fires_2001") 
est_tbbmt_n = st_read("../data/GEE-test/est_tbbmt_n_fires_2001.shp", "est_tbbmt_n_fires_2001") 
est_tbbmt_s = st_read("../data/GEE-test/est_tbbmt_s_fires_2001.shp", "est_tbbmt_s_fires_2001") 
tcst_n = st_read("../data/GEE-test/tcst_n_fires_2001.shp", "tcst_n_fires_2001") 
tcst_s = st_read("../data/GEE-test/tcst_s_fires_2001.shp", "tcst_s_fires_2001") 
```
...
st_write(all_shp_un_poly, "../outputs/test/combine_ecozones_2001-test2.shp", driver="ESRI Shapefile") 
```
...
```{r}
ckmt_nst_nsct_sf = ckmt_nst_nsct_nh %>% st_as_sf() %>% st_cast("POLYGON") 
cpt_bt_east_sf = cpt_bt_east_nh %>% st_as_sf() %>% st_cast("POLYGON") 
cpt_bt_west_sf = cpt_bt_west_nh %>% st_as_sf() %>% st_cast("POLYGON") 
est_tbbmt_n_sf = est_tbbmt_n_nh %>% st_as_sf() %>% st_cast("POLYGON") 
est_tbbmt_s_sf = est_tbbmt_s_nh %>% st_as_sf() %>% st_cast("POLYGON") 
tcst_n_sf = tcst_n_nh %>% st_as_sf() %>% st_cast("POLYGON") 
tcst_s_sf = tcst_s_nh %>% st_as_sf() %>% st_cast("POLYGON") 
...
```{r eval=FALSE, include=FALSE}
st_write(all_shp, "../outputs/test/Testcombine_ecozones_2001_NoNegBuf.shp", driver="ESRI Shapefile") 
