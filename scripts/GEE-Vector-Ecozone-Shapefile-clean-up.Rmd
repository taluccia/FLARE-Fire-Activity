...
# Read in shapefile
```{r}
E_EPoly2_1 = readOGR("../data/2021-05-03_GEE-part2-vectors-EA/E_EPoly2_1_ee_fires90_2001.shp", "E_EPoly2_1_ee_fires90_2001") 
NEPoly1 = readOGR("../data/2021-05-03_GEE-part2-vectors-EA/NEPoly1_ee_fires90_2001.shp", "NEPoly1_ee_fires90_2001") 
W_EPoly2_2 = readOGR("../data/2021-05-03_GEE-part2-vectors-EA/W_EPoly2_2_ee_fires90_2001.shp", "W_EPoly2_2_ee_fires90_2001") 
...
```{r}
E_EPoly2_1_ee = spTransform(E_EPoly2_1, CRS(ee_russia))
NEPoly1_ee = spTransform(NEPoly1, CRS(ee_russia))
W_EPoly2_2_ee = spTransform(W_EPoly2_2, CRS(ee_russia))
```
...
```{r}
all_shp_sf = st_as_sf(all_shp_nbuf)
```
...
# write Shapefile
```{r}
st_write(all_shp_un_poly, "../outputs/GEE-clean-shapefiles-EqualArea/combine_equalarea_2001.shp", driver="ESRI Shapefile") 
```
