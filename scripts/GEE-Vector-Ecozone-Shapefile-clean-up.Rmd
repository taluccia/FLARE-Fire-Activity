...
# Read in shapefile
```{r}
E_EPoly2_1 = st_read("../data/part2-gee-vectors-EqualArea/E_EPoly2_1_ee_fires_2001.shp", "E_EPoly2_1_ee_fires_2001") 
NEPoly1 = st_read("../data/part2-gee-vectors-EqualArea/NEPoly1_ee_fires_2001.shp", "NEPoly1_ee_fires_2001") 
W_EPoly2_2 = st_read("../data/part2-gee-vectors-EqualArea/W_EPoly2_2_ee_fires_2001.shp", "W_EPoly2_2_ee_fires_2001") 
...
```{r}
all_shp = rbind(E_EPoly2_1_buff, NEPoly1_buff, W_EPoly2_2_buff)
```
...
```{r}
st_write(all_shp_un_poly, "../outputs/GEE-clean-shapefiles-EqualArea/combine_ecozones_ea_2001.shp", driver="ESRI Shapefile") 
```
