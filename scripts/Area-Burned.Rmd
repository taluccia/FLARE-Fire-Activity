...
f20 = st_read("../data/clean-shapefile/flare_30m/fires2020.shp", "fires2020")
...
```{r eval=FALSE, include=FALSE}
write.csv(sumdat2,"../outputs/2020-11-19_FLARE-Fire-Summary.csv", row.names = FALSE)
```
...
no_legend1 = ggplot(fire_class, aes(fire_yr)) +scale_fill_brewer(palette = "Spectral") +
      geom_bar(aes(fill=fire_size_class), width = 0.5, position = position_stack(reverse = TRUE)) + 
  xlab("Fire year") +
  ylab("Fire frequency \n(count)") +
...
```{r fig.height=5, fig.width=6}
ledgend_r = ggplot(fire_class, aes(fire_yr, area_ha)) + scale_fill_brewer(palette = "Spectral") +
      geom_bar(stat="identity", aes(fill=fire_size_class), width = 0.5, position = position_stack(reverse = TRUE)) + 
  xlab("Fire year") +
  scale_y_continuous(name = ('Area burned \n(millions of hectares)'), breaks=c(0, 2000000, 4000000, 6000000, 8000000, 10000000), labels = c(0, 2, 4, 6, 8, 10)) +
...
```{r fig.height=4, fig.width=6}
no_legend = ggplot(fire_class, aes(fire_yr, area_ha)) + scale_fill_brewer(palette = "Spectral") +
      geom_bar(stat="identity", aes(fill=fire_size_class), width = 0.5, position = position_stack(reverse = TRUE)) + 
  xlab("Fire year") +
  scale_y_continuous(name = ('Area burned \n(millions of hectares)'), breaks=c(0, 2000000, 4000000, 6000000, 8000000, 10000000), labels = c(0, 2, 4, 6, 8, 10)) +
