...
```{r fig.height=7, fig.width=6}
figure1 = cowplot::plot_grid(plot_area, plot_frq, area_class_no_legend, frq_class_no_legend, plot_area_arctic_nl, plot_frq_arctic_nl, labels = "AUTO", ncol = 2)
...
fig1 = cowplot::plot_grid(figure1,legends, ncol = 1, rel_heights = c(1, .1))

fig1
```

```{r eval=FALSE, include=FALSE}
ggsave("../figures/2021-01-07_manuscript-figure1.png", plot = fig1, width = 6, height = 7, units = c("in"), dpi=600 )
```