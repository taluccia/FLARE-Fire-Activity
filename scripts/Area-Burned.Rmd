...
f02 = st_read("../data/clean-shapefile/flare_30m/fires2002.shp", "fires2002") 
f03 = st_read("../data/clean-shapefile/flare_30m/fires2003.shp", "fires2003")
f04 = st_read("../data/clean-shapefile/flare_30m/fires2004.shp", "fires2004") 
f05 = st_read("../data/clean-shapefile/flare_30m/fires2005.shp", "fires2005") 
```

```{r}
f06 = st_read("../data/clean-shapefile/flare_30m/fires2006.shp", "fires2006") 
f07 = st_read("../data/clean-shapefile/flare_30m/fires2007.shp", "fires2007") 
f08 = st_read("../data/clean-shapefile/flare_30m/fires2008.shp", "fires2008")
f09 = st_read("../data/clean-shapefile/flare_30m/fires2009.shp", "fires2009") 
f10 = st_read("../data/clean-shapefile/flare_30m/fires2010.shp", "fires2010") 
```

```{r}
f11 = st_read("../data/clean-shapefile/flare_30m/fires2011.shp", "fires2011") 
f12 = st_read("../data/clean-shapefile/flare_30m/fires2012.shp", "fires2012") 
f13 = st_read("../data/clean-shapefile/flare_30m/fires2013.shp", "fires2013")
f14 = st_read("../data/clean-shapefile/flare_30m/fires2014.shp", "fires2014") 
f15 = st_read("../data/clean-shapefile/flare_30m/fires2015.shp", "fires2015") 
```

```{r}
f16 = st_read("../data/clean-shapefile/flare_30m/fires2016.shp", "fires2016") 
f17 = st_read("../data/clean-shapefile/flare_30m/fires2017.shp", "fires2017") 
f18 = st_read("../data/clean-shapefile/flare_30m/fires2018.shp", "fires2018")
f19 = st_read("../data/clean-shapefile/flare_30m/fires2019.shp", "fires2019")
```
...
plot_frq = ggplot(fire_frq, aes(fire_yr, n_fires)) +
  geom_bar(stat="identity", width = 0.5, fill="#abdda4") +
  xlab('Year') +
...
```
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-10-14_FireFrequency.png", plot = plot_frq, width = 6, height = 4, units = c("in"), dpi=600 )
```
...
```
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-10-14_AreaBurned.png", plot = plot_area, width = 6, height = 4, units = c("in"), dpi=600 )
```
```{r}
head(fire_area)
head(fire_frq)
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-10-14_area-frequency-fireyear.png", plot = plot_class1, width = 6, height = 5, units = c("in"), dpi=600 )
```
```{r}
head(fire_class)
```
...
```{r eval=FALSE, include=FALSE}
ggsave("../figures/2020-10-14_areaburn-class-fireyear.png", plot = plot_class2, width = 6, height = 5, units = c("in"), dpi=600 )
```
