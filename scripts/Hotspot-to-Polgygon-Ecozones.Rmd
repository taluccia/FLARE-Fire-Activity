...
```{r}
hs = readOGR("../data/M6-march-october/M6_mar-oct_2012.shp", "M6_mar-oct_2012") 
```
...
st_write(ckmt_nst_nsct_hs_wgs_sf, "../outputs/hotspot-poly-ecozone/hspoly_ckmt_nst_nsct_2012.shp", driver="ESRI Shapefile")
```
...
st_write(tcst_n_hs_wgs_sf, "../outputs/hotspot-poly-ecozone/hspoly_tcst_n_2012.shp", driver="ESRI Shapefile")# Write to file
```
...
st_write(tcst_s_hs_wgs_sf, "../outputs/hotspot-poly-ecozone/hspoly_tcst_s_2012.shp", driver="ESRI Shapefile")# Write to file
```
...
st_write(est_tbbmt_n_hs_wgs_sf, "../outputs/hotspot-poly-ecozone/hspoly_est_tbbmt_n_2012.shp", driver="ESRI Shapefile")# Write to file
```
...
st_write(est_tbbmt_s_hs_wgs_sf, "../outputs/hotspot-poly-ecozone/hspoly_est_tbbmt_s_2012.shp", driver="ESRI Shapefile")# Write to file
```
## CPT_BT_EAST
...
st_write(cpt_bt_east_hs_wgs_sf, "../outputs/hotspot-poly-ecozone/hspoly_cpt_bt_east_2012.shp", driver="ESRI Shapefile")# Write to file
...
st_write(cpt_bt_west_hs_wgs_sf, "../outputs/hotspot-poly-ecozone/hspoly_cpt_bt_west_2012.shp", driver="ESRI Shapefile")# Write to file
```
