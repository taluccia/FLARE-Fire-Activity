...
```{r}
hs = readOGR("../data/M6-march-october/M6_mar-oct_2019.shp", "M6_mar-oct_2019") 
```
...
st_write(eco_hs_wgs_sf, "../outputs/hotspot-poly-single-eco/hspoly_singleEco_2020.shp", driver="ESRI Shapefile")
```

## For Large data year (2019 & 2020)
